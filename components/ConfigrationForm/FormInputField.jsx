...
const FormInputField = ({
  ...
  return (
    <div className="form-field">
      <div
        className={`field-content flex items-center justify-between gap-4 max-dex-md:gap-2 max-tab-lg:flex-col max-tab-lg:items-start ${
          active ? "" : "opacity-50"
        }`}
      >
        ...
        <div className="relative w-full max-w-[327px] max-tab-lg:max-w-full">
          <select
          ...
          >
            <path
              d="M6.5 6L0.870835 0.749999L12.1292 0.75L6.5 6Z"
              fill="black"
            />
          </svg>
        </div>
