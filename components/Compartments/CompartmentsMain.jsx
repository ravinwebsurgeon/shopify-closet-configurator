      ...
      <div className="flex flex-wrap gap-2">
        {compartmentData &&
          compartmentData.map((item) =>
            item.id == "sliding_partition" &&
            (dimension.depth <= 20 || dimension.depth > 80) ? (
              <div className="sidepanel-warning font-inter text-[14px] font-medium">
                <strong>
                  Geen Vakverdeling beschikbaar voor deze afmeting
                </strong>
                <p>
                  Vakverdeling is alleen beschikbaar bij de volgende dieptes:
                </p>
